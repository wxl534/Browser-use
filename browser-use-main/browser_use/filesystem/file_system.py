...
class FileSystem:
	...
	def _create_default_files(self) -> None:
		"""Create default results and todo.md files"""
	...
	def describe(self) -> str:
		...
		for file_obj in self.files.values():
			# Skip todo.md.md from description
			if file_obj.full_name == 'todo.md.md':
				continue
	...
	def get_todo_contents(self) -> str:
		...
		todo_file = self.get_file('todo.md.md')
